...
module.exports = {
	...
	executor: async (msg) => {
		...
		const scamLogs = msg.guild.channels.resolve(
			Channels.SCAM_LOGS,
		) as TextChannel | null;
		...
		if (
			...
			if (hasRole === true) {
				const allowedEmbed = makeEmbed({
					...
					thumbnail: {
						url: "https://cdn.discordapp.com/attachments/932350968522240101/932625886275043338/Approved.png",
					},
				...
				const notAllowedEmbed = makeEmbed({
					title: "Potential Scam Alert",
					thumbnail: {
						url: "https://cdn.discordapp.com/attachments/932350968522240101/932625893657026630/Scam.png",
					},
					author: {
						name: msg.author.tag,
						iconURL: msg.author.displayAvatarURL(),

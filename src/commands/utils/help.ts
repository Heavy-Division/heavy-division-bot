...
export const help: CommandDefinition = {
    ...
    executor: async (msg) => {
        const helpEmbed = makeEmbed({
            ...
            description: 'Check out the [Discord Bot Repository](https://github.com/Hypeism/heavy-division-bot/blob/typescript-refactor/.github/COMMANDS.md) for a list of availible commands. ', //TODO Replace hyperlink with Heavy Division Repo one
        });

		...
		fields: [
			{
				...
				value:
					"> You can download the Stable, Development and Experimental builds in <#852748629877850143> You can also download the addon directly from the [GitHub Repository](https://github.com/Heavy-Division/B78XH) to install manually. \n ",
			},
			{
				name: "When is the Next Update?",
				value:
					"> We don't know when the next update will be, however you can keep track of development in <#837105238158082099> and <#821078930840354868>. ",
			},
			{
				name: "How do I join the team?",
				value:
					"> That depends on which role you are seeking. Most team roles are on an invite-only basis. You can message a member of the team you're seeking to join for more info. \n",
			},
			{
				name: "Is it payware?",
			...
			},
			{
				...
				value:
					"> Report it in <#811459130313015328> for one of our developers to see.\n ",
			},
			{

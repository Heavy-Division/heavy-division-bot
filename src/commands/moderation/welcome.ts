...
const HEADER_IMAGE_URL =
	"https://cdn.discordapp.com/attachments/927293618295824415/984448072283222036/hd__banner.png";
const HELP_IMAGE_URL =
	"https://cdn.discordapp.com/attachments/970853183037530123/977399291196899398/Microsoft_Flight_Simulator_Screenshot_2022.05.21_-_11.06.19.01.png";
	...
	fields: [
		{
			...
			value:
				"Be sure to read the <#835982074800373810> if you have a question or issue regarding the B78XH Modification. Check out <#964717019289247754> for any help operating or troubleshooting the B78XH mod. \n",
		},
		{
			name: "Experimental Build and MSFS features",
			value:
				"Please note we do not provide support for the *Experimental build and MSFS features such as the weather engine, or other planes \n",
		},
	],
});

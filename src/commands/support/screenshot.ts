...
const SCREENSHOT_URL = 'https://cdn.discordapp.com/attachments/1025417231573733386/1035516838701973574/apu.png';

export const screenshot: CommandDefinition = {
    name: "screenshot",
    description: 'Provides the way to take a screenshot when reporting a bug.',
    category: CommandCategory.SUPPORT,
    executor: (msg) => {
        const scrEmbed = makeEmbed({
        ...
        return msg.channel.send({ embeds: [scrEmbed] });
    },
};
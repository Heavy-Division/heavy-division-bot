...
const SB_ReferenceError_URL =
	"https://cdn.discordapp.com/attachments/810316915464863774/975182259013439488/unknown.png";

export const sbReferenceError: CommandDefinition = {
	name: ["sbError", "cau"],
	description:
		"Provides solution to SimBrief reference error: Cannot Access Uninitialized",
	category: CommandCategory.SUPPORT,
	executor: (msg) => {
		const sbErrorEmbed = makeEmbed({
			title:
				"Heavy Division | SimBrief Reference Error: Cannot Access Uninitialized",
